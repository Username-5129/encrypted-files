  ...
  <div class="w-full px-8 sm:px-16">
    <div class="flex justify-between h-20 items-center">
      ...
      <div class="flex items-center space-x-4">
        <a href="/register" class="text-[#122C4F] font-semibold text-lg rounded-full px-6 py-3 border border-gray-200 transition-shadow hover:shadow-xl bg-[#FBF9E4] hover:bg-[#f3f1db]">Register</a>
        <a href="/login" class="text-[#122C4F] font-semibold text-lg rounded-full px-6 py-3 border border-gray-200 transition-shadow hover:shadow-xl bg-[#FBF9E4] hover:bg-[#f3f1db]">Login</a>
      </div>
    </div>
  </div>
</nav>