<x-layout>
    ...
    <form method="POST" action="{{ route('file.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50" rows="5">{{ old('description') }}</textarea>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="password_hash" value="{{ old('password_hash') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-opacity-50" required>
        </div>
        ...
        <button type="submit" class="mt-4 bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600">Create file</button>
    </form>
</x-layout>