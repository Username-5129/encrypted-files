                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                    ...
                    <div class="flex flex-col gap-2 md:items-end">
                        ...
                        @can('manageAccess', $file)
                            ...
                            <a href="{{ route('files.logs', $file->id) }}" class="bg-[#5B88B2] text-[#FBF9E4] px-4 py-2 rounded-lg font-semibold shadow hover:bg-[#49709a] transition text-center">Veiw Logs</a>
                            @endcan
                        @can('delete', $file)
